...
Obviously this will only work for the website that is set to 'url' variable but you can implement something similar for your platform by copying and tweaking the code.

-You need chromedriver.exe in the same directory as the autoJoin.py file.
